  ...
  const verifyOTP =
    async () => {
      ...
      if (response.data.success) {
        ...
        localStorage.setItem("RecId", user["User RecId"]);
    ...
    <div className="flex items-center justify-center min-h-screen px-4 bg-gray-100">
      <div className="w-full max-w-md px-8 py-10 bg-gray-100 rounded-2xl animate-fade-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {showOTP && (
            <div>
              <label className="block mb-2 font-mono text-xs tracking-widest text-gray-400">OTP</label>
              <input
                type="text"
                value={otp}
          ...
          <button
            ...
            onClick={showOTP ? verifyOTP : undefined}
            disabled={loading}
